...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        function _addShow(show) {
            var _a = show.show, id = _a.id, name = _a.name, summary = _a.summary, image = _a.image;
            var showObject = {
                id: id,
                name: name,
                summary: "",
        ...
        var tvMazeURL, resp, showData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tvMazeURL = "".concat(BASE_URL, "search/shows");
                    return [4 /*yield*/, axios_1.default.get(tvMazeURL, { params: { q: term } })];
                case 1:
                    resp = _a.sent();
                    showData = resp.data;
                    //TODO: refactor using map
                    showData = resp.data.map(show, function (IShow) { return _addShow(show); });
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var episodesURL, episodeData, episodeMap;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    episodesURL = "".concat(BASE_URL, "shows/").concat(id, "/episodes");
                    return [4 /*yield*/, axios_1.default.get(episodesURL)];
                case 1:
                    episodeData = _a.sent();
                    episodeMap = episodeData.data.map(
                    //next up one
                    function (e) {
                        return {
                            id: e.id,
...
function populateEpisodes(episodes) {
    ...
    for (var _i = 0, episodes_1 = episodes; _i < episodes_1.length; _i++) {
        ...
        var newEpisodeItem = $("<li>").text("".concat(episode.name, " (season ").concat(episode.season, ", number ").concat(episode.number, ")"));
        $("#episodesList").append(newEpisodeItem);
    }
}
function handleGetEpisodes(e) {
    return __awaiter(this, void 0, void 0, function () {
        var id, episodes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    $("#episodesList").empty();
                    id = e.target.closest(".Show").data.showId;
